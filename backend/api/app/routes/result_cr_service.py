...
# Single canonical mapping — class label → numeric score for charts
...
_SCORE_TO_CLASS: dict[int, str] = {v: k for k, v in _CLASS_TO_SCORE.items()}
...
def get_area_progress(
    ...
    """
    Aggregated burnout progress for an area. HR only.
    """
...
def update_result_flag(
    ...
    return service.update_result_flag(result_id, payload.flag)
