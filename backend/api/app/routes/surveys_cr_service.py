...
from app.schemas.surveys_scheme import SurveyResponse, SurveyCreate
...
@router.get("/{survey_id}", response_model=list[SurveyResponse])                                                   # endpoint que obtiene la información de una encuesta dada su UUID
